module TD::Types
  ...
  # @attr default_participant_alias [TD::Types::MessageSender, nil] Default group call participant identifier to join
  #   the voice chat; may be null.
  class VoiceChat < Base
    attribute :group_call_id, TD::Types::Integer
    attribute :has_participants, TD::Types::Bool
    attribute :default_participant_alias, TD::Types::MessageSender.optional.default(nil)
  end
end
